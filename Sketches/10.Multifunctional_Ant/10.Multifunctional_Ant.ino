...
// Positive shifts the front and back to the left
// Negative Shifts the front and back to the right

// Positive Shifts the mid offset to the right
// Negative shifts the mid offset to the left

const int FRONT_OFFSET = 0;
const int MID_OFFSET = 2;
const int BACK_OFFSET = 0;
const uint16_t buzzerNotes[] = { 622, 391, 587, 391, 523, 391, 493, 391, 523, 391, 587, 391, 622, 391, 587, 391, 523, 391, 493, 391, 523, 391, 587, 391, 622, 391, 587, 391, 523, 391, 493, 391, 523, 391, 587, 391, 622, 391, 587, 391, 523, 391, 493, 391, 523, 391, 587, 783, 261, 523, 391, 622, 391, 523 };


bool Sonic_Mode = 0;         //Ultrasonic mode
int Ant_Move_Direction = 0;  //Direction of ant movement
int Ant_Move_Speed = 0;      //Ant speed
// TODO: Could be fun to add a "Play Note" function that just references a hashmap or somethin of key value pairs with notes/hertz values
// Hook that in with mp3 to midi or smthn?


void playHappyBirthday() {
Buzzer_Alert(622); delay(199.166666667); 
Buzzer_Alert(391); delay(199.166666667); 
Buzzer_Alert(587); delay(199.166666667); 
Buzzer_Alert(391); delay(199.166666667); 
Buzzer_Alert(523); delay(199.166666667); 
Buzzer_Alert(391); delay(199.166666667); 
Buzzer_Alert(493); delay(199.166666667); 
Buzzer_Alert(391); delay(199.166666667); 
Buzzer_Alert(523); delay(199.166666667); 
Buzzer_Alert(391); delay(199.166666667); 
Buzzer_Alert(587); delay(199.166666667); 
...
Buzzer_Alert(391); delay(199.166666667); 
Buzzer_Alert(587); delay(199.166666667); 
Buzzer_Alert(783); delay(100.833333333); 
Buzzer_Alert(261); delay(199.166666667); 
Buzzer_Alert(523); delay(199.166666667); 
Buzzer_Alert(391); delay(199.166666667); 
Buzzer_Alert(622); delay(199.166666667); 
Buzzer_Alert(391); delay(199.166666667); 
...
void setup() {
  ...
  Ant_Correct_Angle(FRONT_OFFSET, MID_OFFSET, BACK_OFFSET);  //Change the patament of Ant_Correct_Angle(x1, x2, x3) tp calibrate ant Servo
  delay(100);
}
